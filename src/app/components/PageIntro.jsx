              ...
              <div className="grid grid-cols-1 tablet:grid-cols-2 laptop:grid-cols-3 gap-4">
                <div className="mb-2 d-flex">
                  <div className="item-box radius-15 flex-grow-1 d-flex flex-column">
                    ...
                    <h5 className="mb-15 text-2xl font-bold">Build Seamless Digital Experiences</h5>
                    <p className="text-xl">
                ...
                <div className="mb-2 d-flex">
                  <div className="item-box radius-15 flex-grow-1 d-flex flex-column">
                    ...
                    <h5 className="mb-15 text-2xl font-bold">Enhance Brand Identity</h5>
                    <p className="text-xl">
                ...
                <div className="mb-2 d-flex">
                  <div className="item-box radius-15 flex-grow-1 d-flex flex-column">
                    ...
                    <h5 className="mb-15 text-2xl font-bold">Produce Engaging Multimedia Content</h5>
                    <p className="text-xl">
                ...
                <div className="mb-2 d-flex">
                  <div className="item-box radius-15 flex-grow-1 d-flex flex-column">
                    ...
                    <h5 className="mb-15 text-2xl font-bold">Commit to Continuous Improvement</h5>
                    <p className="text-xl">
        ...
        <div className="flex flex-col gap-12 items-center">
          <div className="valign">
            <div className="content md-mb50">
              {/* <h6 className="sub-title main-color mb-15 text-xl font-bold">About Company</h6> */}
              <h3 className="fw-600 mb-30 text-6xl">
                Our Company <span className="fw-300">Business</span> Strategy
              </h3>
              <p className="text-xl">
                At Sofreg Solutions, our objective is to deliver innovative and high-quality creative services that empower businesses to communicate effectively and achieve their goals.
              </p>
              ...
              <div className="grid grid-cols-1 tablet:grid-cols-2 laptop:grid-cols-3 gap-4">
                <div className="mb-2 d-flex">
                  <div className="item-box radius-15 ">
                    ...
                    <h5 className="mb-15 text-2xl font-bold">Client-Centric Approach Strategy Plan</h5>
                    <p className="text-xl">
                ...
                <div className="mb-2 d-flex">
                  <div className="item-box radius-15">
                    ...
                    <h5 className="mb-15 text-2xl font-bold">Diverse Service Offering Strategy Plan</h5>
                    <p className="text-xl">
                ...
                <div className="mb-2 d-flex">
                  <div className="item-box radius-15">
                    ...
                    <h5 className="mb-15 text-2xl font-bold">Quality and Innovation Strategy Plan</h5>
                    <p className="text-xl">
                ...
                <div className="mb-2 d-flex">
                  <div className="item-box radius-15">
                    ...
                    <h5 className="mb-15 text-2xl font-bold">Strategic Partnerships Strategy Plan</h5>
                    <p className="text-xl">
