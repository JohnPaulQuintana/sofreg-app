        ...
        >
          <div className="caption" style={{ textAlign: "center", color: "white" }}>
            <div className="lg-text fw-600">
              ...
              <div className="text text-[1.3em] laptop:text-[0.7em] ">Discover, Elevate</div>
              <div className="text text-[1.3em] laptop:text-[0.7em] text-color-primary-blue">Revolutionize</div>
            </div>
