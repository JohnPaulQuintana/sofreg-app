...
const WorkSection = ({openModal}) => {
  ...
  const categories = [
    ...
    { id: 46, category: 'web', sub: 'wb', imgSrc: ['assets/imgs/web/web_961motorsport.jpg', 'https://961motorsport.com/'], title: '961 Motor Sport', categoryLabel: 'Website Development', type: 'web' },
    { id: 47, category: 'web', sub: 'wb', imgSrc: ['assets/imgs/web/web_motors.jpg', 'https://motorsportgrowth.com/'], title: 'Motor Sport Growth', categoryLabel: 'Website Development', type: 'web' },
    { id: 48, category: 'web', sub: 'wb', imgSrc: ['assets/imgs/web/web_S4T.jpg', 'https://stage4tuning.com/'], title: 'Stage4tuning', categoryLabel: 'Website Development', type: 'web' },
    { id: 49, category: 'web', sub: 'wb', imgSrc: ['assets/imgs/web/web_AMATARA.jpg', 'https://amatara.com/welleisure/'], title: 'Amatara', categoryLabel: 'Website Development', type: 'web' },
    { id: 50, category: 'web', sub: 'wb', imgSrc: ['assets/imgs/web/web_hotelskophiph.jpg', 'https://tapear-resort.hotelskophiphi.com/en/'], title: 'Tapear Resort', categoryLabel: 'Website Development', type: 'web' },
    { id: 51, category: 'web', sub: 'wb', imgSrc: ['assets/imgs/web/web_PARADOX.jpg', 'https://www.paradoxhotels.com/phuket'], title: 'Paradox Hotels', categoryLabel: 'Website Development', type: 'web' },
    { id: 52, category: 'web', sub: 'wb', imgSrc: ['assets/imgs/web/web_SUNSET_BEACH.jpg', 'https://sunsetbeach.vn/'], title: 'Sunset Beach', categoryLabel: 'Website Development', type: 'web' },
    { id: 53, category: 'web', sub: 'software', imgSrc: ['assets/imgs/web/web_EASTWOODS.jpg','https://gradebook.epcst.edu.ph/login'], title: 'Gradebook', categoryLabel: 'System Development', type: 'web' },
    { id: 54, category: 'web', sub: 'software', imgSrc: ['assets/imgs/web/web_BATAAN_DTS.jpg','https://procurement.bataan.gov.ph/auth'], title: 'Procurement', categoryLabel: 'System Development', type: 'web' },
    { id: 55, category: 'video', sub: 'social_media', imgSrc: ['assets/imgs/video/BMW.jpg', 'https://www.youtube.com/embed/S_t-EnEK_PM'], title: 'Social Media', categoryLabel: 'Video Production', type: 'video' },
    { id: 56, category: 'video', sub: 'social_media', imgSrc: ['assets/imgs/video/Brasil.jpg', 'https://www.youtube.com/embed/4-BAXCaRVIY'], title: 'Social Media', categoryLabel: 'Video Production', type: 'video' },
    { id: 57, category: 'video', sub: 'social_media', imgSrc: ['assets/imgs/video/Client_1.jpg', 'https://www.youtube.com/embed/bUJOjdUK_9g'], title: 'Social Media', categoryLabel: 'Video Production', type: 'video' },
    { id: 58, category: 'video', sub: 'social_media', imgSrc: ['assets/imgs/video/S4T.jpg', ''], title: 'Social Media', categoryLabel: 'Video Production', type: 'video' },
    { id: 59, category: 'video', sub: 'youtube', imgSrc: ['assets/imgs/video/Laptop_advertisement.jpg',''], title: 'YouTube', categoryLabel: 'Video Production', type: 'video' },
    { id: 60, category: 'video', sub: 'corporate', imgSrc: ['assets/imgs/video/thumbnail/CorporateVideoEditing_1.jpg',''], title: 'Corporate Video', categoryLabel: 'Video Production', type: 'video' },
    { id: 61, category: 'video', sub: 'event', imgSrc: ['assets/imgs/video/thumbnail/EventVideoEditing_1.jpg',''], title: 'Event Video', categoryLabel: 'Video Production', type: 'video' },
    { id: 62, category: 'video', sub: 'film', imgSrc: ['assets/imgs/video/Exige.jpg','https://youtube.com/embed/WgOLf8zl1Kw'], title: 'Film/Documentary', categoryLabel: 'Video Production', type: 'video' },
    { id: 63, category: 'video', sub: 'product', imgSrc: ['assets/imgs/video/Cosmetics.jpg','https://youtube.com/embed/-CBQXzdPlAU'], title: 'Product & Tutorial', categoryLabel: 'Video Production', type: 'video' },
    { id: 64, category: 'video', sub: 'product', imgSrc: ['assets/imgs/video/Clothing.jpg',''], title: 'Product & Tutorial', categoryLabel: 'Video Production', type: 'video' },
    { id: 65, category: 'video', sub: 'product', imgSrc: ['assets/imgs/video/Vitamins.jpg',''], title: 'Product & Tutorial', categoryLabel: 'Video Production', type: 'video' },
    { id: 66, category: 'video', sub: 'ai_powered', imgSrc: ['assets/imgs/video/Coastline.jpg',''], title: 'AI-Powered', categoryLabel: 'Video Production', type: 'video' },
    { id: 67, category: 'video', sub: 'ai_powered', imgSrc: ['assets/imgs/video/Scoot.jpg',''], title: 'AI-Powered', categoryLabel: 'Video Production', type: 'video' },
    { id: 68, category: 'video', sub: 'cinematic', imgSrc: ['assets/imgs/video/cinematic_alarm.jpg','https://youtube.com/embed/fICLPQJhHO0'], title: 'Cinematic', categoryLabel: 'Video Production', type: 'video' },
