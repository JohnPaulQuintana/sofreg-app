                        ...
                        <div className="list-serv">
                            <div className="accordion bord">
                                ...
                                <div className="item mb-15 wow fadeInUp" data-wow-delay=".1s">
                                    <div className="title">
                                        <h6 className="font-bold text-xl tablet:text-2xl">What types of projects do you handle in graphic design, video editing, and website development?</h6>
                                        <span className="ico ti-plus"></span>
                                    </div>
                                    <div className="accordion-info">
                                        <p className="text-base tablet:text-xl">We handle a wide range of projects, from creating stunning logos, branding, and marketing materials to producing high-quality videos for promotions, ads, and social media. Our website development services include everything from custom websites to e-commerce solutions, ensuring a seamless experience across design, video, and web.</p>
                                    </div>
                                </div>

                                <div className="item active mb-15 wow fadeInUp" data-wow-delay=".3s">
                                    <div className="title">
                                        <h6 className="font-bold text-xl tablet:text-2xl">How do you ensure my project meets my vision and needs?</h6>
                                        <span className="ico ti-plus"></span>
                                    </div>
                                    <div className="accordion-info">
                                        <p className="mb-30 text-base tablet:text-xl">We collaborate closely with our clients, ensuring open communication throughout the process. We begin by understanding your goals and vision, then provide creative solutions tailored to your brand. Regular feedback loops during design, video editing, and website development ensure we meet your expectations at every stage.</p>
