                    ...
                    <div className="col-lg-4 valign">
                        <div className="sec-head info-box full-width md-mb80">
                            <div className="phone fz-30 fw-600 underline main-color">
                                <a href="#0">+63 917 7070 531</a>
                            </div>
                            <div className="morinfo mt-50 pb-30 bord-thin-bottom">
                                <h6 className="mb-15 text-xl">Address</h6>
                                <p>Quezon City Metro Manila, Philippines</p>
                            </div>
                            <div className="morinfo mt-30 pb-30 bord-thin-bottom">
                                <h6 className="mb-15 text-xl">Email</h6>
                                <p>info@sofregsolutions.com</p>
                            </div>
                    ...
                    <div className="col-lg-7 offset-lg-1 valign">
                        <div className="full-width">
                            <div className="sec-head mb-50">
                                <h6 className="sub-title main-color mb-15 font-bold">Let's Chat</h6>
